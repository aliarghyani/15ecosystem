...
import { useI18n, useColorMode, useAppConfig, computed, onMounted, ref, nextTick } from '#imports'
import { useViewTransitionRipple } from '@/composables/useViewTransitionRipple'
